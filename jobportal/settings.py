...
#       'NAME': 'mydatabase',       # use the database you created
#        'USER': 'myuser',           # the role/user you created
#        'PASSWORD': 'Ku5ma8r@24',   # the password you set
#        'HOST': 'localhost',
#        'PORT': '5432',
#    }
#}
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'career' "static") # this is your static folder
]
